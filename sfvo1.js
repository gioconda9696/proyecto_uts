                    ...
                    try {
                        if (destinatarios.length > 0) {
                            ...
                            const mailOptions = {
                                ...
                                subject: 'Archivo Excel de datos actuales en el SFVO1',
                                text: 'Se adjunta el archivo Excel con los datos actuales en el SFVO1.',
                                attachments: [{
    ...
    try {
        ...
        if (results.length > 0 && destinatarios.length > 0) {
            ...
            const mailOptions = {
                from: 'proyectotelecomunicacionesuts@gmail.com',
                to: destinatariosList,
                subject: 'Base de Datos exportada de el SFVO1',
                text: 'estos son los datos tomados dentro de los 15 dias de el SFVO1',
                attachments: [{
